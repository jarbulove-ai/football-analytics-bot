...
def build_ai_prompt(match_data: dict, analysis_mode: str = "default") -> str:
    detail_instruction = (
        ...
        "таблицей и стилем игры. В каждом важном блоке сначала сформулируй "
        "главный вывод, затем отдельным предложением назови основной риск или "
        "ограничение данных."
        if analysis_mode == "premium"
        else
        "Дай содержательное и компактное объяснение ключевых факторов матча. "
        "После главного вывода кратко назови основной риск или ограничение "
        "данных."
    )
    ...
    return (
        ...
        "Обе команды забьют, Жёлтые карточки, Угловые. Для signal.value "
        ...
        "Ограничения длины: summary — максимум 3-4 предложения; context — "
        "4-5; form — 5-6; lineups_and_absences — 4-5; tactical_notes — 5-6; "
        "scenario — 4-5 предложений. Каждый signal.reason — максимум 2-3 "
        "предложения. risks — максимум 4-5 коротких пунктов.\n"
